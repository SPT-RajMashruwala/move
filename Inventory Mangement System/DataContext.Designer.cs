...
// Code is generated on: 1/22/2022 4:38:29 PM
//
...
namespace ProductInventoryContext
{
    ...
    public partial class Issue : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// There are no comments for PurchaseDetail in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="PurchaseDetail_Issue", Storage="_PurchaseDetail", ThisKey="ProductID", OtherKey="PurchaseID", IsForeignKey=true)]
        public PurchaseDetail PurchaseDetail
        {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._PurchaseDetail.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("PurchaseDetail");
                    ...
                    if (value != null)
                    {
                        this._ProductID = value.PurchaseID;
    ...
    public partial class PurchaseDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for Issues in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="PurchaseDetail_Issue", Storage="_Issues", ThisKey="PurchaseID", OtherKey="ProductID", DeleteRule="NO ACTION")]
        public EntitySet<Issue> Issues
        {
            get
            {
