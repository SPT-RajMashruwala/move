...
namespace KarkhanaBook.Controllers.Challan
{
    ...
    public class TakaChallanController : ControllerBase
    {
        ...
        public IActionResult Add([FromBody] Models.Challan.TakaChallan value) 
        {
        ...
        public IActionResult Update([FromBody] Models.Challan.TakaChallan value,[FromRoute] int ID)
        {
