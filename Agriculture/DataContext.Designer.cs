...
// Code is generated on: 15-02-2022 15:08:35
//
...
namespace ProductInventoryContext
{
    ...
    public partial class ProductInventoryDataContext : Devart.Data.Linq.DataContext
    {
        ...
        base(@"Data Source=DESKTOP-PF2SA84;Initial Catalog=ProductInventory;Integrated Security=False;Persist Security Info=True;User ID=SuperAdmin;Password=123456789", mappingSource)
        {
            OnCreated();
        }
...
namespace ProductInventoryContext
{
    ...
    public partial class Category : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<Product> _Products_CategoryID;

        private EntitySet<Product> _Products_CategoryID1;
        ...
        public Category()
        {
            ...
            this._Products_CategoryID = new EntitySet<Product>(new Action<Product>(this.attach_Products_CategoryID), new Action<Product>(this.detach_Products_CategoryID));
            this._Products_CategoryID1 = new EntitySet<Product>(new Action<Product>(this.attach_Products_CategoryID1), new Action<Product>(this.detach_Products_CategoryID1));
            OnCreated();
        }
        ...
        /// </summary>
        [Column(Storage = "_CategoryName", DbType = "VARCHAR(30)", UpdateCheck = UpdateCheck.Never)]
        ...
        /// <summary>
        /// There are no comments for Products_CategoryID in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Category_Product", Storage="_Products_CategoryID", ThisKey="CategoryID", OtherKey="CategoryID", DeleteRule="NO ACTION")]
        public EntitySet<Product> Products_CategoryID
        {
            get
            {
                return this._Products_CategoryID;
            }
            set
            {
                this._Products_CategoryID.Assign(value);
            }
        }

    
        /// <summary>
        /// There are no comments for Products_CategoryID1 in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Category_Product1", Storage="_Products_CategoryID1", ThisKey="CategoryID", OtherKey="CategoryID", DeleteRule="NO ACTION")]
        public EntitySet<Product> Products_CategoryID1
        {
            get
            {
                return this._Products_CategoryID1;
            }
            set
            {
                this._Products_CategoryID1.Assign(value);
            }
        }
        ...
        private void attach_Products_CategoryID(Product entity)
        {
            this.SendPropertyChanging("Products_CategoryID");
            entity.Category_CategoryID = this;
        }
    
        private void detach_Products_CategoryID(Product entity)
        {
            this.SendPropertyChanging("Products_CategoryID");
            entity.Category_CategoryID = null;
        }

        private void attach_Products_CategoryID1(Product entity)
        {
            this.SendPropertyChanging("Products_CategoryID1");
            entity.Category_CategoryID1 = this;
        }
    
        private void detach_Products_CategoryID1(Product entity)
        {
            this.SendPropertyChanging("Products_CategoryID1");
            entity.Category_CategoryID1 = null;
        }
    }
    ...
    public partial class LoginDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<Product> _Products_LoginID;

        private EntitySet<Product> _Products_LoginID1;
        ...
        public LoginDetail()
        {
            ...
            this._Products_LoginID = new EntitySet<Product>(new Action<Product>(this.attach_Products_LoginID), new Action<Product>(this.detach_Products_LoginID));
            this._Products_LoginID1 = new EntitySet<Product>(new Action<Product>(this.attach_Products_LoginID1), new Action<Product>(this.detach_Products_LoginID1));
        ...
        /// <summary>
        /// There are no comments for Products_LoginID in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="LoginDetail_Product", Storage="_Products_LoginID", ThisKey="LoginID", OtherKey="LoginID", DeleteRule="NO ACTION")]
        public EntitySet<Product> Products_LoginID
        {
            get
            {
                return this._Products_LoginID;
            }
            set
            {
                this._Products_LoginID.Assign(value);
            }
        }

    
        /// <summary>
        /// There are no comments for Products_LoginID1 in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="LoginDetail_Product1", Storage="_Products_LoginID1", ThisKey="LoginID", OtherKey="LoginID", DeleteRule="NO ACTION")]
        public EntitySet<Product> Products_LoginID1
        {
            get
            {
                return this._Products_LoginID1;
            }
            set
            {
                this._Products_LoginID1.Assign(value);
            }
        }
        ...
        private void attach_Products_LoginID(Product entity)
        {
            this.SendPropertyChanging("Products_LoginID");
            entity.LoginDetail_LoginID = this;
        }
    
        private void detach_Products_LoginID(Product entity)
        {
            this.SendPropertyChanging("Products_LoginID");
            entity.LoginDetail_LoginID = null;
        }

        private void attach_Products_LoginID1(Product entity)
        {
            this.SendPropertyChanging("Products_LoginID1");
            entity.LoginDetail_LoginID1 = this;
        }
    
        private void detach_Products_LoginID1(Product entity)
        {
            this.SendPropertyChanging("Products_LoginID1");
            entity.LoginDetail_LoginID1 = null;
        }
    ...
    public partial class MainArea : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_MainAreaName", DbType = "VARCHAR(50)", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class ProductionDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_VegetableID", DbType = "INT", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Storage = "_Quantity", DbType = "FLOAT", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<LoginDetail> _LoginDetail_LoginID;

        private EntityRef<Category> _Category_CategoryID;

        private EntityRef<ProductUnit> _ProductUnit;

        private EntityRef<LoginDetail> _LoginDetail_LoginID1;

        private EntityRef<Category> _Category_CategoryID1;
        ...
        {
            this._Issues = new EntitySet<Issue>(new Action<Issue>(this.attach_Issues), new Action<Issue>(this.detach_Issues));
            this._LoginDetail_LoginID  = default(EntityRef<LoginDetail>);
            this._Category_CategoryID  = default(EntityRef<Category>);
            this._ProductUnit  = default(EntityRef<ProductUnit>);
            this._LoginDetail_LoginID1  = default(EntityRef<LoginDetail>);
            this._Category_CategoryID1  = default(EntityRef<Category>);
            this._PurchaseDetails = new EntitySet<PurchaseDetail>(new Action<PurchaseDetail>(this.attach_PurchaseDetails), new Action<PurchaseDetail>(this.detach_PurchaseDetails));
            OnCreated();
        }
        ...
        /// </summary>
        [Column(Storage = "_ProductName", DbType = "VARCHAR(80)", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Storage = "_Variety", DbType = "VARCHAR(80)", UpdateCheck = UpdateCheck.Never)]
        ...
        public int? CategoryID
        {
            ...
            set
            {
                if (this._CategoryID != value)
                {
                    if (this._Category_CategoryID.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        public int? LoginID
        {
            ...
            set
            {
                if (this._LoginID != value)
                {
                    if (this._LoginDetail_LoginID.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        /// </summary>
        [Column(Storage = "_UnitID", DbType = "INT", UpdateCheck = UpdateCheck.Never)]
        public int? UnitID
        {
            get
            {
        ...
        /// <summary>
        /// There are no comments for LoginDetail_LoginID in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="LoginDetail_Product", Storage="_LoginDetail_LoginID", ThisKey="LoginID", OtherKey="LoginID", IsForeignKey=true)]
        public LoginDetail LoginDetail_LoginID
        {
            get
            {
                return this._LoginDetail_LoginID.Entity;
            }
            set
            {
                LoginDetail previousValue = this._LoginDetail_LoginID.Entity;
                if ((previousValue != value) || (this._LoginDetail_LoginID.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("LoginDetail_LoginID");
                    if (previousValue != null)
                    {
                        this._LoginDetail_LoginID.Entity = null;
                        previousValue.Products_LoginID.Remove(this);
                    }
                    this._LoginDetail_LoginID.Entity = value;
                    if (value != null)
                    {
                        this._LoginID = value.LoginID;
                        value.Products_LoginID.Add(this);
                    }
                    else
                    {
                        this._LoginID = default(int?);
                    }
                    this.SendPropertyChanged("LoginDetail_LoginID");
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for Category_CategoryID in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Category_Product", Storage="_Category_CategoryID", ThisKey="CategoryID", OtherKey="CategoryID", IsForeignKey=true)]
        public Category Category_CategoryID
        {
            get
            {
                return this._Category_CategoryID.Entity;
            }
            set
            {
                Category previousValue = this._Category_CategoryID.Entity;
                if ((previousValue != value) || (this._Category_CategoryID.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("Category_CategoryID");
                    if (previousValue != null)
                    {
                        this._Category_CategoryID.Entity = null;
                        previousValue.Products_CategoryID.Remove(this);
                    }
                    this._Category_CategoryID.Entity = value;
                    if (value != null)
                    {
                        this._CategoryID = value.CategoryID;
                        value.Products_CategoryID.Add(this);
                    }
                    else
                    {
        ...
        /// <summary>
        /// There are no comments for LoginDetail_LoginID1 in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="LoginDetail_Product1", Storage="_LoginDetail_LoginID1", ThisKey="LoginID", OtherKey="LoginID", IsForeignKey=true)]
        public LoginDetail LoginDetail_LoginID1
        {
            get
            {
                return this._LoginDetail_LoginID1.Entity;
            }
            set
            {
                LoginDetail previousValue = this._LoginDetail_LoginID1.Entity;
                if ((previousValue != value) || (this._LoginDetail_LoginID1.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("LoginDetail_LoginID1");
                    if (previousValue != null)
                    {
                        this._LoginDetail_LoginID1.Entity = null;
                        previousValue.Products_LoginID1.Remove(this);
                    }
                    this._LoginDetail_LoginID1.Entity = value;
                    if (value != null)
                    {
                        this._LoginID = value.LoginID;
                        value.Products_LoginID1.Add(this);
                    }
                    else
                    {
                        this._LoginID = default(int?);
                    }
                    this.SendPropertyChanged("LoginDetail_LoginID1");
                }
            }
        }
        ...
        /// <summary>
        /// There are no comments for Category_CategoryID1 in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Category_Product1", Storage="_Category_CategoryID1", ThisKey="CategoryID", OtherKey="CategoryID", IsForeignKey=true)]
        public Category Category_CategoryID1
        {
            get
            {
                return this._Category_CategoryID1.Entity;
            }
            set
            {
                Category previousValue = this._Category_CategoryID1.Entity;
                if ((previousValue != value) || (this._Category_CategoryID1.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("Category_CategoryID1");
                    if (previousValue != null)
                    {
                        this._Category_CategoryID1.Entity = null;
                        previousValue.Products_CategoryID1.Remove(this);
                    }
                    this._Category_CategoryID1.Entity = value;
                    if (value != null)
                    {
                        this._CategoryID = value.CategoryID;
                        value.Products_CategoryID1.Add(this);
                    }
                    else
                    {
                        this._CategoryID = default(int?);
                    }
                    this.SendPropertyChanged("Category_CategoryID1");
                }
            }
        }
    ...
    public partial class ProductUnit : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_Type", DbType = "VARCHAR(20)", UpdateCheck = UpdateCheck.Never)]
        public string Type
        {
            get
            {
        ...
        /// There are no comments for PurchaseDetails in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ProductUnit_PurchaseDetail", Storage="_PurchaseDetails", ThisKey="UnitID", OtherKey="UnitID", DeleteRule="NO ACTION")]
        public EntitySet<PurchaseDetail> PurchaseDetails
        {
            get
            {
    ...
    public partial class PurchaseDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_TotalQuantity", DbType = "FLOAT", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Storage = "_TotalCost", DbType = "FLOAT", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Storage = "_PurchaseDate", DbType = "DATE", UpdateCheck = UpdateCheck.Never)]
        ...
        /// There are no comments for ProductUnit in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ProductUnit_PurchaseDetail", Storage="_ProductUnit", ThisKey="UnitID", OtherKey="UnitID", IsForeignKey=true)]
        public ProductUnit ProductUnit
        {
            get
            {
    ...
    public partial class SubArea : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_SubAreaName", DbType = "VARCHAR(50)", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class UserRefreshToken : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for RefreshID in the schema.
        /// </summary>
        [Column(Storage = "_RefreshID", DbType = "INT", UpdateCheck = UpdateCheck.Never)]
        public int? RefreshID
        {
            get
            {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._User.HasLoadedOrAssignedValue == false))
                {
                    ...
                    if (previousValue != null)
                    {
                        ...
                        previousValue.UserRefreshToken = null;
                    }
                    this._User.Entity = value;
                    if (value != null)
                    {
                        this._UserID = value.UserID;
                        value.UserRefreshToken = this;
                    }
                    else
                    {
    ...
    public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<UserRefreshToken> _UserRefreshToken;
        ...
        public User()
        {
            this._UserRefreshToken  = default(EntityRef<UserRefreshToken>);
        ...
        public int UserID
        {
            ...
            set
            {
                if (this._UserID != value)
                {
                    if (this._UserRefreshToken.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        /// There are no comments for UserName in the schema.
        /// </summary>
        [Column(Storage = "_UserName", DbType = "VARCHAR(100)", UpdateCheck = UpdateCheck.Never)]
        public string UserName
        {
            get
            {
        ...
        /// </summary>
        [Column(Storage = "_EmailAddress", DbType = "VARCHAR(80)", UpdateCheck = UpdateCheck.Never)]
        ...
        /// There are no comments for SystemMAC in the schema.
        /// </summary>
        [Column(Storage = "_SystemMAC", DbType = "VARCHAR(30)", UpdateCheck = UpdateCheck.Never)]
        public string SystemMAC
        {
            get
            {
        ...
        /// <summary>
        /// There are no comments for UserRefreshToken in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="User_UserRefreshToken", Storage="_UserRefreshToken", ThisKey="UserID", OtherKey="UserID", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
        public UserRefreshToken UserRefreshToken
        {
            get
            {
                return this._UserRefreshToken.Entity;
            }
            set
            {
                UserRefreshToken previousValue = this._UserRefreshToken.Entity;
                if ((previousValue != value) || (this._UserRefreshToken.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("UserRefreshToken");
                    if (previousValue != null)
                    {
                        this._UserRefreshToken.Entity = null;
                        previousValue.User = null;
                    }
                    this._UserRefreshToken.Entity = value;
                    if (value != null)
                    {
                        value.User = this;
                    }
                    this.SendPropertyChanged("UserRefreshToken");
                }
            }
        }
    ...
    public partial class Vegetable : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_VegetableName", DbType = "VARCHAR(50)", UpdateCheck = UpdateCheck.Never)]
